...
export const HISTORICAL_BENCHMARKS: Record<string, string> = {
  ...
  [EX.dbBenchPress]: '~40 kg per dumbbell × 10 (late 2025)',
  ...
  [EX.smithSquat]: '~80 kg free-bar squat (late 2025 — Smith bar path feels different)',
  [EX.squat]: '~80 kg (late 2025)',
  [EX.dbRomanianDeadlift]: '~100 kg barbell RDL (late 2025 — dumbbells will cap lower)',
